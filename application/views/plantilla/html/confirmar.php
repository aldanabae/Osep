...
<html lang="en">
	...
	<body class="no-skin">
		...
		<input class="form-control" id="campo" name="campo" placeholder=""  type="text">

		<button id="id-btn-dialog2" class="btn btn-info btn-sm" type="submit">
						...
						buttons: [
							{
								...
								click: function() {
									$( this ).dialog( location.href = 'mensaje.php' );
								}
							}
							,
							{
