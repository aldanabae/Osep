											...
											<ul class="nav nav-tabs" id="myTab3">
												...
												<li>
													<a data-toggle="tab" href="#tab4">
														<i class="ace-icon fa fa-life-ring"></i>
														Contacto a soporte.
													</a>
												</li>
											</ul>
													...
													<div class="row">
														<div class="col-sm-6">
															...
															<p>
																...
																<a href=" <?php echo base_url('assets/images/helps/Screenshot_1.jpg') ?>" data-rel="colorbox">
																	<img class="img-responsive"  src="<?php echo base_url('assets/images/helps/Screenshot_1.jpg') ?>" />
																	<div class="text">
