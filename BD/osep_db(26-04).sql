...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-04-2017 a las 20:44:02
...
(3, 2, 'Utilizacion de Servicios de Salud', 'Bloque para Afiliados', 1, 2),
...
(1, 'Pedro', 'Robles', 18687347, 40, 'M', 1, 1868734700),
(2, 'Romina', 'Gomez', 19467239, 38, 'F', 1, 1868734702),
(3, 'Rocio', 'Cordoba', 32145234, 32, 'F', 1, 122131141),
(4, 'Diego', 'Roberti', 21242134, 45, 'M', 1, NULL);
...
(101, 'Nombre del Encuestado', NULL, NULL, 2, 6, NULL),
(102, 'Apellidos del Encuestado', NULL, NULL, 2, 6, NULL);
...
(1, NULL, 1, NULL, 87, 2),
(2, NULL, 1, NULL, 88, 150),
(3, '30 minutos', 1, NULL, 89, 0),
(4, '5 días', 1, NULL, 90, 0),
(5, '4985678', 1, NULL, 91, 0),
(6, '18 horas', 1, NULL, 92, 0),
(7, NULL, 1, NULL, 93, 1),
(8, NULL, 1, NULL, 67, 116),
(9, NULL, 1, NULL, 67, 117),
(10, NULL, 1, NULL, 67, 118),
(11, NULL, 1, NULL, 68, 1),
(12, NULL, 1, NULL, 69, 124),
(13, NULL, 1, NULL, 69, 127),
(14, NULL, 1, 1, 6, 3),
(15, '40 años', 1, 1, 7, 0),
(16, NULL, 1, 2, 10, 22),
(17, '8 horas', 1, 2, 71, 0),
(18, 'Casa de Gobierno', 1, 3, 72, 0),
(19, NULL, 1, 3, 94, 1),
(20, '3500 Gramos', 1, 1, 18, 0),
(21, NULL, 1, 2, 33, 74),
(22, NULL, 1, 1, 40, 38),
(23, NULL, 1, 3, 55, 1),
(24, '3 Meses', 1, 3, 59, 0),
(25, NULL, 1, NULL, 77, 134),
(26, NULL, 1, NULL, 78, 139),
(27, NULL, 1, 1, 17, 57),
(28, NULL, 0, NULL, 0, 0),
(29, NULL, 0, NULL, 0, 0),
(30, NULL, 0, NULL, 0, 0);
...
--
ALTER TABLE `encuestado`
  MODIFY `idEncuestado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `pregunta`
  MODIFY `idPregunta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
--
...
--
ALTER TABLE `respuesta_elegida`
  MODIFY `idRespuestaElegida` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
--
-- AUTO_INCREMENT de la tabla `respuesta_pregunta`
--
ALTER TABLE `respuesta_pregunta`
  MODIFY `idRespPreg` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=261;
--
