...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-04-2017 a las 21:35:10
...
INSERT INTO `encuestado` (`idEncuestado`, `nombreEncuestado`, `apellidoEncuestado`, `dniEncuestado`, `edad`, `sexo`, `idRelevamiento`, `idAfiliado`) VALUES
(2, 'Carlos', 'Menem', 11111111, 50, 'M', 48, NULL),
(3, 'Pepe', 'Robles', 32085237, 50, 'M', 48, NULL),
(4, 'Susi', 'Correa', 22222222, 34, 'F', 48, NULL),
(5, 'Cecilia', 'Paez', 33333333, 34, 'F', 48, NULL);
...
(12, '¿Qué cobertura de salud tiene, OSEP u otra cobertura?', NULL, NULL, 2, 2, 4),
...
(83, '', NULL, NULL, 0, 0, NULL),
(84, '', NULL, NULL, 0, 0, NULL);
...
INSERT INTO `relevamiento` (`idRelevamiento`, `nroRelevamiento`, `fechaRelevamiento`, `observCriticidad`, `idCriticidad`, `idEncuesta`, `idVisita`) VALUES
(42, 2324124, '0000-00-00', 'Alta', 2, 1, NULL);
...
INSERT INTO `respuesta_elegida` (`idRespuestaElegida`, `respBreve`, `idRelevamiento`, `idEncuestado`, `idRespPreg`) VALUES
(35, NULL, 42, NULL, 2),
(36, 'Claveles Mendocinos', 42, NULL, NULL),
(37, '24', 42, NULL, NULL),
(127, NULL, 48, 2, 20),
(128, NULL, 48, 3, 6),
(129, 'Barrio Solares', 48, 4, NULL),
(130, '45', 48, 5, NULL);
...
--
ALTER TABLE `pregunta`
  MODIFY `idPregunta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
--
-- AUTO_INCREMENT de la tabla `relevamiento`
--
ALTER TABLE `relevamiento`
  MODIFY `idRelevamiento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
--
-- AUTO_INCREMENT de la tabla `respuesta`
--
ALTER TABLE `respuesta`
  MODIFY `idRespuesta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=151;
--
-- AUTO_INCREMENT de la tabla `respuesta_elegida`
--
ALTER TABLE `respuesta_elegida`
  MODIFY `idRespuestaElegida` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=139;
--
-- AUTO_INCREMENT de la tabla `respuesta_pregunta`
--
ALTER TABLE `respuesta_pregunta`
  MODIFY `idRespPreg` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=232;
--
