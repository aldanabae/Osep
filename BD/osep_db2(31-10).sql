...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-10-2017 a las 21:05:06
...
(5, 'Alex', 'Leyton', 8358, 'Planta Permanente', 18857073, NULL, NULL, NULL, 1, 6, 5),
...
(17, 'Diana', 'López', 4778, 'Planta Permanente', 25259878, NULL, NULL, NULL, 1, 6, 17),
...
(28, 'Laura', 'Carmona', 3233, 'Planta Permanente', 14736621, NULL, NULL, NULL, 1, 6, 28),
...
(34, 'Marcela', 'Méndez', 5774, 'Planta Permanente', 20525232, NULL, NULL, NULL, 1, 3, 0),
...
(54, 'Silvana', 'Ponce', 3714, 'Planta Permanente', 25194725, NULL, NULL, NULL, 1, 6, 54),
(55, 'Teodora', 'Taca', 1875, 'Planta Permanente', 18808738, NULL, NULL, NULL, 1, 5, 34),
(56, 'Victor', 'Araujo', 8079, 'Planta Permanente', 28819421, NULL, NULL, NULL, 1, 6, 56),
...
(65, 'Susana', 'Luna', 6277, 'Planta Permanente', 17641838, NULL, NULL, NULL, 1, 6, 65),
...
(106, 'Observaciones generales', NULL, NULL, 1, 6, NULL),
...
--
-- Estructura de tabla para la tabla `referente_dpto`
--

CREATE TABLE `referente_dpto` (
  `idRefDpto` int(11) NOT NULL,
  `idEmpleado` int(11) NOT NULL,
  `id_tdeparta` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `referente_dpto`
--

INSERT INTO `referente_dpto` (`idRefDpto`, `idEmpleado`, `id_tdeparta`) VALUES
(1, 17, 16),
(2, 28, 17),
(3, 54, 11),
(4, 43, 14),
...
(4, 1, '2017-08-30', '', 1, 1, 0, 4, 17, 'a:3:{s:8:"cantidad";s:1:"3";s:8:"embarazo";s:1:"1";s:6:"edades";i:0;}', '222222222222222222222222222222', '33232323', '33232323', 1, ''),
(5, 1, '2017-08-30', '', 1, 1, NULL, 5, 62, 'a:3:{s:8:"cantidad";s:1:"2";s:8:"embarazo";s:1:"1";s:6:"edades";i:0;}', '33333', '4434343', '4434343', 0, ''),
...
(7, 5, '2017-09-18', '', 1, 1, 0, 7, 16, 'a:3:{s:8:"cantidad";s:1:"3";s:8:"embarazo";s:1:"1";s:6:"edades";i:0;}', 'aaaaaaaaaaaaaaaaaaa', '432403', '432403', 1, '');
...
(2, 'Coordinador', ''),
(3, 'Coordinador - Referente', ''),
(4, 'Referente', ''),
(5, 'Facilitador', ''),
(6, 'Referente - Facilitador', '');
...
INSERT INTO `usuario` (`idUsuario`, `contrasenia`, `usuario`, `token`, `idNivel`, `idEmpleado`) VALUES
(1, '81dc9bdb52d04dc20036dbd8313ed055', 'aldana', '', 5, 2),
(2, 'c893bad68927b457dbed39460e6afd62', 'osep', '', 5, 3);
...
--
-- Indices de la tabla `referente_dpto`
--
ALTER TABLE `referente_dpto`
  ADD PRIMARY KEY (`idRefDpto`),
...
--
-- AUTO_INCREMENT de la tabla `referente_dpto`
--
ALTER TABLE `referente_dpto`
  MODIFY `idRefDpto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
